Dilithion Testnet v1.1.18 - Windows x64
======================================

WHAT'S NEW IN v1.1.18:
- FIX: Sent transactions now appear in transaction history (BUG #104)
- Web wallet shows both sent and received transactions
