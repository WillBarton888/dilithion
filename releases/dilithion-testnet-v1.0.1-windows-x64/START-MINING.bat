...
if errorlevel 1 (
    ...
    echo.
    echo  Common causes:
    echo    - Extracted to Program Files (requires admin)
    echo    - Directory is read-only
    echo    - Network drive with restricted permissions
    echo    - USB drive with write protection
    echo.
    echo  To fix:
    echo    1. Extract to: C:\Users\%USERNAME%\Dilithion
    echo    2. OR right-click this file
...
REM =======================================================
REM CRITICAL FIX #5: Check available disk space (need 1GB min)
REM =======================================================
...
echo    [32m✓[0m Ports 18444 and 18332 available
