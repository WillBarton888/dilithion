...
*
* Description: Generates public and private key deterministically from a seed.
*              This enables HD wallet derivation with Dilithium.
*
* Arguments:   - uint8_t *pk: pointer to output public key (allocated
*                             array of CRYPTO_PUBLICKEYBYTES bytes)
*              - uint8_t *sk: pointer to output private key (allocated
*                             array of CRYPTO_SECRETKEYBYTES bytes)
*              - const uint8_t *seed: pointer to 32-byte input seed
*
* Returns 0 (success)
**************************************************/
