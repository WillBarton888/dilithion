...
load_genesis_block:  // Bug #29: Label for automatic retry after blockchain wipe
        ...
        if (!Genesis::IsGenesisBlock(genesis)) {
            ...
            error.recovery_steps = {
                ...
                "Run `dilv-node --reset-chain` to wipe chain data while preserving wallet and MIK registration",
        ...
        // See dilithion-node.cpp for full context. Default OFF; flag is
        // EXPERIMENTAL / DEVELOPER-ONLY through PR6.5b.6.
                    ...
                    if (peerHeight > 0 || hasHandshakes) {
                        ...
                        if (height == 0 && peerHeight > 0) {
                            ...
                            if (stuck_mins >= 10 && since_warning >= 5) {
                                ...
                                std::cout << "  [WARN]   2. Run `dilv-node --reset-chain` to wipe chain data (preserves wallet.dat + mik_registration.dat)" << std::endl;
