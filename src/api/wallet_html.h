    ...
    <nav class="sidebar">
        <div class="logo">
            <svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M50 5 L90 25 L90 55 C90 75 70 90 50 95 C30 90 10 75 10 55 L10 25 Z" fill="url(#logoGrad)"/>
                <path d="M50 20 L35 50 L45 50 L40 80 L65 45 L52 45 L60 20 Z" fill="white"/>
            </svg>
