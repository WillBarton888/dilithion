    ...
    <script>
        ...
        async function refreshBalance() {
            try {
                ...
                const immature = await rpcCall('getimmaturebalance').catch(() => 0);
                const total = balance + (immature || 0);
                ...
                document.getElementById('immatureBalance').textContent = (immature || 0).toFixed(8);
