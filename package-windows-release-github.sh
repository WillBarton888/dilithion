...
cp /mingw64/bin/libgmp-10.dll "${RELEASE_DIR}/" || { echo "ERROR: Failed to copy libgmp-10.dll"; exit 1; }
...
cp START-MINER-GUI.bat "${RELEASE_DIR}/" || { echo "ERROR: Failed to copy START-MINER-GUI.bat"; exit 1; }
