...
function updateCountdown() {
    ...
    if (distance < 0) {
        ...
        if (countdownContainer) {
            countdownContainer.innerHTML = '<div class="mainnet-live-banner" style="background: linear-gradient(135deg, #22c55e, #16a34a);"><h2>MAINNET IS LIVE!</h2><p>Download v2.0.17 and start mining real DIL coins today!</p></div>';
        }
